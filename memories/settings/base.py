...
from memories.settings.packages.rest_framework import *
...
SECRET_KEY = 'django-insecure-82#(6@vesoo6e1iun7bychk^*o5y7vq)e(lcy+^p_*^9=rt#)2'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    Path.cwd().joinpath(BASE_DIR).joinpath('memories/assets')
]
